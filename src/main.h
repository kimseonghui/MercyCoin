...
static const int64_t MAX_MONEY = 35290000000 * COIN;
...
static const uint256 hashGenesisBlock("0x00000640ec6186432064a6fa9025036a30eb1562a76a9b1d72fe94757b7bca35");
static const uint256 hashGenesisBlockTestNet("0x00000640ec6186432064a6fa9025036a30eb1562a76a9b1d72fe94757b7bca35");
...
public:
    ...
    {
        // MercyCoin: the coin stake transaction is marked with the first output empty
    ...
    */
    ...
    bool GetCoinAge(CTxDB& txdb, uint64_t& nCoinAge) const;  // MercyCoin: get transaction coin age
...
public:
    ...
    // MercyCoin: block signature - signed by one of the coin base txout[N]'s owner
    ...
    // MercyCoin: two types of block: proof-of-work or proof-of-stake
    ...
    // MercyCoin: get max transaction timestamp
    ...
    bool AcceptBlock();
    bool GetCoinAge(uint64_t& nCoinAge) const; // MercyCoin: calculate total coin age spent in block
...
public:
    ...
    unsigned int nFile;
    unsigned int nBlockPos;
    uint256 nChainTrust; // MercyCoin: trust score of block chain
    int nHeight;

    int64_t nMint;
    int64_t nMoneySupply;

    unsigned int nFlags;  // MercyCoin: block index flags
    enum  
    {
